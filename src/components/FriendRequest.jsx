...
const FriendRequest = () => {
    ...
    return (
        <div className='md:w-1/2 bg-green-400 flex flex-col w-full  justify-center gap-16 items-center h-screen'>
            ...
            <div className='w-96 flex flex-col px-2 py-6 justify-center gap-8 items-center h-2/3 bg-blue-200'>
                ...
                <button onClick={requestHendler} ref={requestRef} className='w-full font-semibold uppercase bg-black text-white py-4'>Add</button>
            </div>
        </div>
    )
}
